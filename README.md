This is a data science project that involves using a given dataset to create a model, train the model based on the dataset and test the model using the same dataset.
